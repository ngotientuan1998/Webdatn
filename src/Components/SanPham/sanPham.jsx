                                    ...
                                    {branList.length > 0 ? (
                                       ...
                                       { branList.map((brandObj, index) => (
                                            <li
                                                ...
                                                onClick={
                                                    () => {
                                                        handleBrandClick(brandObj.brand.toLowerCase());
                                                        setsearchBranch(brandObj.brand.toLowerCase())
                                                    }}>
                                                {brandObj.brand} ({brandObj.count}) {/* Hiển thị tên hãng và số lượng */}
                                            </li>
                                            
                                        ))}
                                             <li className="list-item" onClick={()=>{setSelectedBrand(null);setsearchBranch('Hãng Máy')}}>  Tất cả sản phẩm</li>
                                        </>
